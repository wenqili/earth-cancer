...
DAT.Globe = function (container, opts) {
  ...
  function init() {
    ...
    let skin = textureLoader.load("./skin.jpeg")
    skin.minFilter = THREE.LinearFilter
    
    uniforms['texture'].value = skin;
  ...
  function addPoint(lat, lng, size, color, subgeo) {
    ...
    var cancer = new THREE.Mesh(tgeometry, material1);

    cancer.position.x = point.position.x;
    cancer.position.y = point.position.y;
    cancer.position.z = point.position.z;
    cancer.scale.x = cancer.scale.y = cancer.scale.z = point.scale.z * 0.03;
